    ...
    return (
        <div className="w-full max-w-sm my-10 p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form className="mt-6" onSubmit={handleSubmit(create)}>
                ...
                <div className="mt-6">
                    <button className="w-full border px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
                        {senddata ?
